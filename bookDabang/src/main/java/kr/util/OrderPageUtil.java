...
public class OrderPageUtil {
	 ...
	 * */
	public OrderPageUtil(int currentPage,int count, int rowCount) {
	...
	public OrderPageUtil(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
		...
		if(count >= 0) {
			...
			if(pageCount > 0) {
				...
				if (currentPage > pageCount) {
					page.append("<a href="+pageUrl+"?user_orderpageNum="+ (startPage - 1) + sub_url +">");
					page.append("[이전]");
					page.append("</a>");
				}
				...
				for (int i = startPage; i <= endPage; i++) {
					...
					if (i == currentPage) {
						...
						page.append("&nbsp;<a href='"+pageUrl+"?user_orderpageNum=");
						page.append(i);
						page.append(sub_url+"'>");
						page.append(i);
						page.append("</a>");
