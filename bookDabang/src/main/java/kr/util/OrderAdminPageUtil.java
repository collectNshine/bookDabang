...
public class OrderAdminPageUtil {
	 ...
	 * */
	public OrderAdminPageUtil(int currentPage,int count, int rowCount) {
	...
	public OrderAdminPageUtil(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
		...
		if(count >= 0) {
			...
			if(pageCount > 0) {
				...
				if (currentPage > pageCount) {
					page.append("<a href="+pageUrl+"?adminOrderpageNum="+ (startPage - 1) + sub_url +">");
					page.append("[이전]");
					page.append("</a>");
				}
				...
				for (int i = startPage; i <= endPage; i++) {
					...
					if (i == currentPage) {
						...
						page.append("&nbsp;<a href='"+pageUrl+"?adminOrderpageNum=");
						page.append(i);
						page.append(sub_url+"'>");
						page.append(i);
						page.append("</a>");
				...
				if (totalPage - startPage >= pageCount) {
					page.append("<b><a href="+pageUrl+"?adminOrderpageNum="+ (endPage + 1) + sub_url +"style='color:rgba(5, 59, 68, .3);'>");
					page.append("[다음]");
					page.append("</a></b>");
				}
			}else {
