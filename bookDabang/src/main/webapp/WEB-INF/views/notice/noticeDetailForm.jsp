...
$(function(){
	...
	function selectList(pageNum){
		...
		$.ajax({
			url:'listReply.do',
			type:'post',
			data:{pageNum:pageNum,noti_num:${noti.noti_num}},
			dataType:'json',
			success:function(data){
				//작업을 성공하면 목록 list를 제공한다.
				count = data.count;
				rowCount = data.rowCount;
				
				if(pageNum == 1){
					//처음 호출되는 div 내용물을 제거한다.
					$('#output').empty();
				}
				//------------------------------------
...
<div>
	<form id="re_form">
		<input type="hidden" name="noti_num" value="${noti.noti_num}" id="noti_num">
