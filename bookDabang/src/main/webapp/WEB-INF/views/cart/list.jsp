			...
			<form id="cart_order" action="${pageContext.request.contextPath}/order/orderForm.do" method="post">
				...
				<ul class="list-group">
					<li class="list-group-item">
						<ul>
							<!-- <li><div class="cart-check"><input type="checkbox" id="check_all" class="form-check-input me-1" checked="checked"></div></li> -->
					...
					<li class="list-group-item">
						<ul class="cart-booklist">
							<%-- <li><div class="cart-check"><input type="checkbox" name="selectBook" value="${cart.bookVO.price * cart.order_quantity}" class="select-book form-check-input me-1" checked="checked"></div></li> --%>
							...
							<li><div class="cart-bookprice"><fmt:formatNumber value="${cart.bookVO.price}"/>원</div></li>
							<li>
